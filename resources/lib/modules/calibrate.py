    ...
    def do_wizard(self):
        try:
            ...
            self.oe.winOeMain.set_wizard_text("Calibrating your screen will ensure that [COLOR FFFF1C77]Ras[/COLOR][COLOR FFFF9522]Plex[/COLOR] is displayed at the proper size."
                               + '[CR][CR]' + "It is a quick process that involves you lining up the calibration arrows with the corners of your screen. Once calibration is finished, hit the back or escape to continue with the setup wizard."
