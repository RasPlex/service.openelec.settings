...
class bluetoothAgent(dbus.service.Object):
    ...
    def AuthorizeService(self, device, uuid):
        try:
            ...
            self.oe.dbg_log('bluetooth::btAgent::AuthorizeService', 'enter_function', 0)
            xbmcDialog = xbmcgui.Dialog()
            answer = xbmcDialog.yesno('RasPlex Bluetooth', 'AuthorizeService')
            if answer == 1:
    ...
    def RequestConfirmation(self, device, passkey):
        try:
            ...
            xbmcDialog = xbmcgui.Dialog()
            answer = xbmcDialog.yesno('RasPlex Bluetooth', 'RequestConfirmation', unicode(passkey))
    ...
    def RequestAuthorization(self, device):
        try:
            ...
            xbmcDialog = xbmcgui.Dialog()
            answer = xbmcDialog.yesno('RasPlex Bluetooth', 'RequestAuthorization')
            if hasattr(self.parent, 'pinkey_window'):
